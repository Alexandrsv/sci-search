...
CREATE INDEX IF NOT EXISTS idx_42699_issne ON public.magazines USING btree (issne);

--
-- Name: idx_42699_issnp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42699_issnp ON public.magazines USING btree (issnp);

--
-- Name: idx_42699_journalid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42699_journalid ON public.magazines USING btree (journalid);

--
-- Name: idx_42699_magazine; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42699_magazine ON public.magazines USING btree (magazine);

--
-- Name: idx_42699_siteurl; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42699_siteurl ON public.magazines USING btree (site_url);

--
-- Name: idx_42738_doicodeunique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS idx_42738_doicodeunique ON public.publishers USING btree (doicode);

--
-- Name: idx_42748_doiunique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS idx_42748_doiunique ON public.scimag USING btree (doi);

--
-- Name: idx_42748_issneindex; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42748_issneindex ON public.scimag USING btree (issne);

--
-- Name: idx_42748_issnpindex; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42748_issnpindex ON public.scimag USING btree (issnp);

--
-- Name: idx_42748_issueindex; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42748_issueindex ON public.scimag USING btree (issue);

--
-- Name: idx_42748_md5; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42748_md5 ON public.scimag USING btree (md5);

--
-- Name: idx_42748_pubmedindex; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42748_pubmedindex ON public.scimag USING btree (pubmedid);

--
-- Name: idx_42748_visibleid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42748_visibleid ON public.scimag USING btree (visible, id);

--
-- Name: idx_42748_volumeindex; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_42748_volumeindex ON public.scimag USING btree (volume);

--
-- Name: idx_scimag_abstract_fts; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_abstract_fts ON public.scimag USING gin (to_tsvector('english'::regconfig, abstract));

--
-- Name: idx_scimag_abstract_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_abstract_gin ON public.scimag USING gin (abstract public.gin_trgm_ops);

--
-- Name: idx_scimag_author_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_author_gin ON public.scimag USING gin (author public.gin_trgm_ops);

--
-- Name: idx_scimag_citation_count; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_citation_count ON public.scimag USING btree (citation_count);

--
-- Name: idx_scimag_doi2; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_doi2 ON public.scimag USING btree (doi2);

--
-- Name: idx_scimag_journalid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_journalid ON public.scimag USING btree (journalid);

--
-- Name: idx_scimag_title_fts; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_title_fts ON public.scimag USING gin (to_tsvector('english'::regconfig, (title)::text));

--
-- Name: idx_scimag_title_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_title_gin ON public.scimag USING gin (title public.gin_trgm_ops);

--
-- Name: idx_scimag_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_type ON public.scimag USING btree (type);

--
-- Name: idx_scimag_year; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_scimag_year ON public.scimag USING btree (year);
...
-- Additional indexes from add_sort_indexes migration
CREATE INDEX IF NOT EXISTS "idx_scimag_citation_year_month_day" ON public.scimag ("citation_count", "year", "month", "day");
CREATE INDEX IF NOT EXISTS "idx_scimag_year_month_day" ON public.scimag ("year", "month", "day");
